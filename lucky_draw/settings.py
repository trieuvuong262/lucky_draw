...
SECRET_KEY = 'django-insecure-sg%(5*xg=wim@h+_u$cc9v@nvs+yx!jyrd0ljkzi#@4i%u8fht'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['trieuvuong1997.pythonanywhere.com']
...
# Đường dẫn URL để truy cập trên trình duyệt
MEDIA_URL = '/media/'
